...
def dataconnexions():
    ...
    return redirect(url_for('gouvlu.dataconnexions6'))
...
@blueprint.route('/c3')
def c3():
    return redirect(url_for('gouvlu.climate_change_challenge'))
...
def gouvlu_sitemap_urls():
    ...
    yield 'gouvlu.dataconnexions_redirect', {}, None, 'monthly', 0.4
    yield 'gouvlu.redevances_redirect', {}, None, 'yearly', 0.4
    yield 'gouvlu.terms_redirect', {}, None, 'monthly', 0.2
    yield 'gouvlu.credits_redirect', {}, None, 'monthly', 0.2
